...
En esta sesión veremos los distintos métodos del ciclo de vida de los componentes de React. Veremos ejemplos prácticos de cómo hacer operaciones comunes con los métodos del ciclo de vida. Por último, echaremos un vistazo a la extensión de depuración (_debugging_) de React para navegadores.
