...
Si no sabemos cuántos elementos vamos a tener o que nombre darle a cada elemento
...
// Crea una variable con dos números
var arr2 = [1, 2];

// Crea una variable con cuatro datos
var arr3 = [
  'Laura',
  'Pedro',
  'Marta',
...
Y te estarás preguntando, ¿y en qué me afecta esto a mi?. Imaginemos que creamos un array llamado `arr`:
...
Bien, ahora que sabemos cómo crear un array, es el momento de descubrir cómo podemos obtener información a partir de él. Como hemos comentado anteriormente, los arrays contiene una lista de datos y cada uno de esos datos va asociado a un número, un índice.
...
## Propiedades y métodos del los arrays
...
// resultado será igual a ['a', 'b', 'c', 1, 2, 3, true, false]
```
...
El método `push()` es uno de los más importantes y sirve para agregar uno o más elementos al final de un array. Es la forma común en JavaScript de añadir elementos a un array y suele ser uno de los más utilizados. Este método tras agregar los elementos al array devuelve la nueva longitud de este.
...
El método `unshift()` sirve para agregar uno o más elementos al principio de un array. Este método tras agregar los elementos al array devuelve la nueva longitud de este.
